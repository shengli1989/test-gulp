...
readConfig = (fileName) -> yaml.safeLoad(fs.readFileSync("#{basePath.config}#{fileName}.yml", 'utf-8'))

module.exports = { gulp, $, basePath, src, dest, resizedImagesFolder, readConfig }
